...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/NShunjian/ModuleB'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'NShunjian' => '528392911@qq.com' }
  #s.source           = { :git => 'https://github.com/NShunjian/ModuleB.git', :tag => s.version.to_s }
  s.source           = { :git => 'https://github.com/NShunjian/ModuleB.git', :branch =>'master' }
